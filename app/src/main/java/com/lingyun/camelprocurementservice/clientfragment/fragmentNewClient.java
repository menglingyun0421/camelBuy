...
public class fragmentNewClient extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fragment_new_client);
        ...
        newclient_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name.equals("")) {
                    Toast.makeText(fragmentNewClient.this, "用户昵称不能为空", Toast.LENGTH_LONG).show();
                    return;
                } else {
                    ...
                    if (username.equals("camel")) {
                        ...
                        Toast.makeText(fragmentNewClient.this, "保存用户成功", Toast.LENGTH_LONG).show();
                        ...
                        for (int i=0;i<midList.size();i++){
                            if (name.equals(midList.get(i))){
                                DialogUtils.TipDialog(fragmentNewClient.this,"用户名已存在，请更换用户名", new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
